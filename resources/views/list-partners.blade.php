                            ...
                            <table class="striped left" style="background-color: bisque;">
                                ...
                                <tbody class="tdtd">
                                    <tr style="padding:5px 5px">
                                        <td style="padding:5px 5px" class="blue-grey-text chib">Neville Temu</td>
                                        <td style="padding:5px 5px" class="blue-grey-text chib">sample@gmail.com</td>
                                        <td style="padding:5px 5px" class="blue-grey-text chib">716693327</td>
                                        <td style="padding:5px 5px" class="blue-grey-text chib">Arusha</td>
                                        <td style="padding:5px 5px" class="">
                                            <!-- Dropdown Trigger -->
                                            <a class="dropdown-trigger btn-flat blue-grey-text" href="#" data-target="dropdown1"
                                                style="text-transform: none; height: 25px; line-height: 26px;background:rgba(51,51,51,.05) !important">
                                                <i class="material-icons">more_horiz</i>
                                            </a>

                                            <!-- Dropdown Structure -->
                                            <ul id="dropdown1" class="dropdown-content">
                                                <li><a href="#!"><i class="material-icons left">edit</i>Edit</a></li>
                                                <li><a href="#!"><i class="material-icons left">delete</i>Delete</a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                </tbody>

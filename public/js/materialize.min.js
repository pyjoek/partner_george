...
/***/ "./resources/css/inc/materialize.min.js":
/*!**********************************************!*\
  !*** ./resources/css/inc/materialize.min.js ***!
  \**********************************************/
...
!function (t) {
  ...
  function n(n, s) {
    ...
    var o,
      a = n,
      r = 0;
    if (A(n)) a = R.test(n) ? O.getElementById(n.slice(1)) : P.test(n) ? e(n) : t(n, s);else if (S(n)) return i(n), this;
    if (!a) return this;
    if (a.nodeType || a === L) this[0] = a, this.length = 1;else for (o = this.length = a.length; r < o; r++) this[r] = a[r];
    return this;
  }
  function s(t, e) {
    return new n(t, e);
  ...
  var x,
    ...
    I = function I() {},
    S = function S(t) {
      return _typeof(t) == _typeof(I) && t.call;
    },
    A = function A(t) {
  ...
  Object.defineProperty(j, "constructor", {
    value: s
  }), s.parseHTML = e, s.noop = I, s.isFunction = S, s.isString = A, s.extend = j.extend = function (t) {
    t = t || {};
  ...
  j.extend({
    ...
    filter: function filter(t) {
      if (!t) return this;
      var e = S(t) ? t : r(t);
      return s(D.call(this, function (i) {
        return e(i, t);
      }));
    },
  ...
  var N = function () {
    ...
    q = function () {
      ...
      return function (i) {
        if (i = N(i), t[i]) return t[i];
        var n = i.charAt(0).toUpperCase() + i.slice(1);
        return o((i + " " + ["webkit", "moz", "ms", "o"].join(n + " ") + n).split(" "), function (n) {
          if (n in e) return t[n] = i = t[i] = n, !1;
        }), t[i];
      };
    }();
  s.prefixedProp = q, s.camelCase = N, j.extend({
    css: function css(t, e) {
      if (A(t)) return t = q(t), arguments.length > 1 ? this.each(function (i) {
        return i.style[t] = e;
    ...
    on: function on(t, e, n, s) {
      var o;
      if (!A(t)) {
        for (var r in t) this.on(r, e, t[r]);
        return this;
      }
      return S(e) && (n = e, e = null), "ready" === t ? (i(n), this) : (e && (o = n, n = function n(t) {
        ...
        var _i = n;
        s && (_i = function i() {
          n.apply(this, arguments), _(e, t, _i);
        }), y(e, t, _i);
      }));
    },
  ...
  return j.extend({
    ...
    parents: function parents(t) {
      var e,
        i = [];
      return this.each(function (n) {
        for (e = n; e && e.parentNode && e !== O.body.parentNode;) e = e.parentNode, (!t || t && a(e, t)) && i.push(e);
      }), l(i);
    },
    prev: function prev() {
...
!function (t) {
  ...
  return M;
		...
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : 0, M.keys = {
  TAB: 9,
  ENTER: 13,
  ESC: 27,
  ARROW_UP: 38,
...
document.addEventListener("keydown", docHandleKeydown), document.addEventListener("keyup", docHandleKeyup), M.initializeJqueryWrapper = function (t, e, i) {
  jQuery.fn[e] = function (n) {
    ...
    if ("object" == _typeof(n) || !n) return t.init(this, arguments[0]), this;
...
!function (t) {
  ...
  function e(t, e) {
    for (var i = t.length, n = 2 <= arguments.length ? arguments[1] : void 0, s = [], o = 0; o < i; o++) if (o in t) {
      var a = t[o];
  ...
  function B(t) {
    ...
    function s(t) {
      for (var i = 0, n = {}, s = v.animations, o = s.length; i < o;) {
        ...
        if (l = h.length) for (f = h[0], d = 0; d < l; d++) u = h[d + 1], m = c[d], isNaN(m) || (f = u ? f + (m + u) : f + (m + " "));else f = c[0];
        j[a.type](r.target, a.property, f, n, r.id), a.currentValue = f, i++;
      }
      if (i = Object.keys(n).length) for (s = 0; s < i; s++) I || (I = p(document.body, "transform") ? "transform" : "-webkit-transform"), v.animatables[s].target.style[I] = n[s].join(" ");
    ...
    function r(t) {
      ...
      if (v.children.length) {
        var y = v.children,
          _ = y.length;
        if (g >= v.currentTime) for (var k = 0; k < _; k++) y[k].seek(g);else for (; _--;) y[_].seek(g);
      }
    ...
    return v.reset = function () {
      ...
      v.paused && (v.paused = !1, h = 0, d = n(v.currentTime), F.push(v), z || N());
    }, v.reverse = function () {
      ...
      return function (e, i, n, s) {
        if (0 <= e && 1 >= e && 0 <= n && 1 >= n) {
          ...
          return function (a) {
            ...
            if (.001 <= h) {
              for (r = 0; 4 > r && 0 != (h = 3 * (1 - 3 * n + 3 * e) * l * l + 2 * (3 * n - 6 * e) * l + 3 * e); ++r) var d = t(l, e, n) - a, l = l - d / h;
              a = l;
  ...
  return B.version = "2.2.0", B.speed = 1, B.running = F, B.remove = function (t) {
    t = w(t);
    for (var e = F.length; e--;) for (var i = F[e], n = i.animations, o = n.length; o--;) s(t, n[o].animatable.target) && (n.splice(o, 1), n.length || i.pause());
  ...
  }, B.setDashoffset = function (t) {
    var e = k(t);
    return t.setAttribute("stroke-dasharray", e), e;
  }, B.bezier = P, B.easings = W, B.timeline = function (t) {
    var e = B(t);
  ...
  var i = {
    ...
    n = function (n) {
      ...
      return _inherits(s, Component), _createClass(s, [{
        ...
        value: function value() {
          this._handleCollapsibleClickBound = this._handleCollapsibleClick.bind(this), this.el.addEventListener("click", this._handleCollapsibleClickBound);
        }
      }, {
  ...
  var i = {
    ...
    n = function (n) {
      function s(e, i) {
        _classCallCheck(this, s);
        var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
        return n.el.M_Dropdown = n, s._dropdowns.push(n), n.id = M.getIdFromTrigger(e), n.dropdownEl = document.getElementById(n.id), n.$dropdownEl = t(n.dropdownEl), n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.focusedIndex = -1, n.filterQuery = [], n.options.container ? t(n.options.container).append(n.dropdownEl) : n.$el.after(n.dropdownEl), n._makeDropdownFocusable(), n._resetFilterQueryBound = n._resetFilterQuery.bind(n), n._handleDocumentClickBound = n._handleDocumentClick.bind(n), n._handleDropdownKeydownBound = n._handleDropdownKeydown.bind(n), n._handleTriggerKeydownBound = n._handleTriggerKeydown.bind(n), n._setupEventHandlers(), n;
      }
      return _inherits(s, Component), _createClass(s, [{
        key: "destroy",
        value: function value() {
        ...
        value: function value() {
          document.body.addEventListener("click", this._handleDocumentClickBound, !0), document.body.addEventListener("touchend", this._handleDocumentClickBound), this.dropdownEl.addEventListener("keydown", this._handleDropdownKeydownBound);
        }
      }, {
        key: "_removeTemporaryEventHandlers",
        value: function value() {
          document.body.removeEventListener("click", this._handleDocumentClickBound, !0), document.body.removeEventListener("touchend", this._handleDocumentClickBound), this.dropdownEl.removeEventListener("keydown", this._handleDropdownKeydownBound);
        }
      }, {
        key: "_handleClick",
        value: function value(t) {
        ...
        value: function value(e) {
          ...
          if (o && -1 === a.indexOf(e.which)) {
            ...
            var r = this.filterQuery.join(""),
              l = t(this.dropdownEl).find("li").filter(function (e) {
        ...
        value: function value() {
          -1 === this.dropdownEl.tabIndex && (this.dropdownEl.tabIndex = 0), t(this.dropdownEl).children().attr("tabindex", 0);
        }
      }, {
        ...
        key: "close",
        value: function value() {
          this.isOpen && (this.isOpen = !1, this.focusedIndex = -1, "function" == typeof this.options.onCloseStart && this.options.onCloseStart.call(this, this.el), this._animateOut(), this._removeTemporaryEventHandlers(), this.el.focus());
        }
      }], [{
        key: "init",
        value: function value(t, e) {
  ...
  var i = {
    ...
    n = function (n) {
      function s(e, i) {
        _classCallCheck(this, s);
        var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
        return n.el.M_Modal = n, n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.id = n.$el.attr("id"), n._openingTrigger = void 0, n.$overlay = t('<div class="modal-overlay"></div>'), s._count++, n._setupEventHandlers(), n;
      }
      return _inherits(s, Component), _createClass(s, [{
        key: "destroy",
        value: function value() {
  ...
  var i = {
    ...
    n = function (n) {
      function s(e, i) {
        _classCallCheck(this, s);
        var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
        return n.el.M_Tabs = n, n.options = t.extend({}, s.defaults, i), n.$tabLinks = n.$el.children("li.tab").children("a"), n.index = 0, n._setTabsAndTabWidth(), n._setupActiveTabLink(), n._createIndicator(), n.options.swipeable ? n._setupSwipeableTabs() : n._setupNormalTabs(), n._setupEventHandlers(), n;
      }
      return _inherits(s, Component), _createClass(s, [{
        key: "destroy",
        value: function value() {
        ...
        value: function value(e) {
          ...
          if (s.length && s.parent().hasClass("tab")) if (n.hasClass("disabled")) e.preventDefault();else if (!s.attr("target")) {
        ...
        value: function value() {
          ...
          i.first().before(n), n.append(i), i[0].style.display = "", this._tabsCarousel = M.Carousel.init(n[0], {
            fullWidth: !0,
            noWrap: !0,
            onCycleTo: function onCycleTo(i) {
              var n = e.index;
  ...
  var i = {
    ...
    n = function (n) {
      function s(e, i) {
        _classCallCheck(this, s);
        var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
        return n.el.M_Tooltip = n, n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.isHovered = !1, n._appendTooltipEl(), n._setupEventHandlers(), n;
      }
      return _inherits(s, Component), _createClass(s, [{
        key: "destroy",
        value: function value() {
          t(this.tooltipEl).remove(), this._removeEventHandlers(), this.$el[0].M_Tooltip = void 0;
        }
      }, {
        ...
        key: "_setupEventHandlers",
        value: function value() {
          this.handleMouseEnterBound = this._handleMouseEnter.bind(this), this.handleMouseLeaveBound = this._handleMouseLeave.bind(this), this.$el[0].addEventListener("mouseenter", this.handleMouseEnterBound), this.$el[0].addEventListener("mouseleave", this.handleMouseLeaveBound);
        }
      }, {
        key: "_removeEventHandlers",
        value: function value() {
          this.$el[0].removeEventListener("mouseenter", this.handleMouseEnterBound), this.$el[0].removeEventListener("mouseleave", this.handleMouseLeaveBound);
        }
      }, {
        key: "open",
        value: function value() {
  ...
  var i = {
    ...
    n = function () {
      ...
      return _createClass(n, [{
        ...
        value: function value() {
          var e = document.createElement("div");
          return e.classList.add("toast"), this.options.classes.length && t(e).addClass(this.options.classes), ("object" == (typeof HTMLElement === "undefined" ? "undefined" : _typeof(HTMLElement)) ? this.message instanceof HTMLElement : this.message && "object" == _typeof(this.message) && null !== this.message && 1 === this.message.nodeType && "string" == typeof this.message.nodeName) ? e.appendChild(this.message) : this.message.jquery ? t(e).append(this.message[0]) : e.innerHTML = this.message, n._container.appendChild(e), e;
        }
      }, {
        key: "_animateIn",
        value: function value() {
  ...
  var i = {
    ...
    n = function (n) {
      function s(e, i) {
        _classCallCheck(this, s);
        var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
        return n.el.M_Sidenav = n, n.id = n.$el.attr("id"), n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.isFixed = n.el.classList.contains("sidenav-fixed"), n.isDragged = !1, n._createOverlay(), n._createDragTarget(), n._setupEventHandlers(), n._setupClasses(), n._setupFixed(), s._sidenavs.push(n), n;
      }
      return _inherits(s, Component), _createClass(s, [{
        key: "destroy",
        value: function value() {
        ...
        value: function value() {
          this.isDragged && (this.percentOpen > .5 ? this.open() : this._animateOut(), this.isDragged = !1);
        }
      }, {
        ...
        value: function value() {
          this.isOpen && this.isDragged && (this.percentOpen > .5 ? this._animateIn() : this.close(), this.isDragged = !1);
        }
      }, {
        ...
        value: function value() {
          !0 !== this.isOpen && (this.isOpen = !0, "function" == typeof this.options.onOpenStart && this.options.onOpenStart.call(this, this.el), this._isCurrentlyFixed() ? (e.remove(this.el), e({
            ...
            duration: 0,
            easing: "easeOutQuad"
          }), this._enableBodyScrolling(), this._overlay.style.display = "none") : (this._preventBodyScrolling(), this.isDragged && 1 == this.percentOpen || this._animateIn()));
        }
      }, {
        key: "close",
        value: function value() {
  ...
  var e = {
    ...
    i = function (i) {
      function n(e, i) {
        _classCallCheck(this, n);
        var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
        return s.el.M_Autocomplete = s, s.options = t.extend({}, n.defaults, i), s.isOpen = !1, s.count = 0, s.activeIndex = -1, s.oldVal, s.$inputField = s.$el.closest(".input-field"), s.$active = t(), s._setupDropdown(), s._setupEventHandlers(), s;
      }
      return _inherits(n, Component), _createClass(n, [{
        key: "destroy",
        value: function value() {
        ...
        key: "_setupDropdown",
        value: function value() {
          this.container = document.createElement("ul"), t(this.container).addClass("autocomplete-content dropdown-content"), this.$inputField.append(this.container);
        }
      }, {
        key: "_removeDropdown",
        value: function value() {
        ...
        value: function value() {
          t(this.container).empty(), this._resetCurrentElement(), this.oldVal = null, t(this.container).css({
            display: ""
          }), this.isOpen = !1;
        }
      }, {
        ...
        value: function value(e, i) {
          ...
          this._removeAutocomplete();
          var s = [];
          for (var o in e) if (e.hasOwnProperty(o) && -1 !== o.toLowerCase().indexOf(i)) {
  ...
  M.updateTextFields = function () {
    ...
    t(document).on("keyup", "input[type=radio], input[type=checkbox]", function (e) {
      if (e.which === M.keys.TAB) return t(this).addClass("tabbed"), void t(this).one("blur", function (e) {
  ...
  var i = {
    ...
    n = function (n) {
      function s(i, n) {
        ...
        return o.el.M_Slider = o, o.options = t.extend({}, s.defaults, n), o.$slider = o.$el.find(".slides"), o.$slides = o.$slider.children("li"), o.activeIndex = o.$slider.find(".active").index(), -1 != o.activeIndex && (o.$active = o.$slides.eq(o.activeIndex)), o._setSliderHeight(), o.$slides.find(".caption").each(function (t) {
  ...
  var e = {
    ...
    i = function (i) {
      function n(e, i) {
        _classCallCheck(this, n);
        var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
        s.el.M_Datepicker = s, s.options = t.extend({}, n.defaults, i), i && i.hasOwnProperty("i18n") && "object" == _typeof(i.i18n) && (s.options.i18n = t.extend({}, n.defaults.i18n, i.i18n)), s.options.minDate && s.options.minDate.setHours(0, 0, 0, 0), s.options.maxDate && s.options.maxDate.setHours(0, 0, 0, 0), s.id = M.guid(), s._setupVariables(), s._insertHTMLIntoDOM(), s._setupModal(), s._setupEventHandlers(), s.options.defaultDate || (s.options.defaultDate = new Date(Date.parse(s.el.value)), s.options.setDefaultDate = !0);
      ...
      return _inherits(n, Component), _createClass(n, [{
        key: "destroy",
        value: function value() {
          this._removeEventHandlers(), this.modal.destroy(), t(this.modalEl).remove(), this.el.M_Datepicker = void 0;
        }
      }, {
        ...
        key: "renderTitle",
        value: function value(e, i, n, s, o, a) {
          var r = void 0,
            l = void 0,
            h = void 0,
            d = this.options,
        ...
        value: function value(t) {
          if (this.isOpen || t) {
            ...
            }), u.addEventListener("change", this._handleYearChange.bind(this)), c.addEventListener("change", this._handleMonthChange.bind(this)), "function" == typeof this.options.onDraw && this.options.onDraw(this);
          }
        }
      }, {
        key: "_setupEventHandlers",
        ...
        value: function value() {
          var e = this;
          this.$modalEl = t(n._template), this.modalEl = this.$modalEl[0], this.calendarEl = this.modalEl.querySelector(".pika-single"), this.yearTextEl = this.modalEl.querySelector(".year-text"), this.dateTextEl = this.modalEl.querySelector(".date-text"), this.clearBtn = this.modalEl.querySelector(".datepicker-clear"), this.todayBtn = this.modalEl.querySelector(".datepicker-today"), this.doneBtn = this.modalEl.querySelector(".datepicker-done"), this.formats = {
            d: function d() {
        ...
        value: function value() {
          this.date = new Date(), this.setInputValue(), this.close();
        }
      }, {
  ...
  var e = {
    ...
    i = function (i) {
      function n(e, i) {
        ...
        }), s.showIndicators && s.$el.append(s.$indicators), s.count = s.images.length, s.xform = "transform", ["webkit", "Moz", "O", "ms"].every(function (t) {
          var e = t + "Transform";
      ...
      return _inherits(n, Component), _createClass(n, [{
        ...
        value: function value(t) {
          var e = void 0,
            i = void 0,
            n = void 0;
          if (this.pressed) if (e = this._xpos(t), i = this._ypos(t), n = this.reference - e, Math.abs(this.referenceY - i) < 30 && !this.verticalDragged) (n > 2 || n < -2) && (this.dragged = !0, this.reference = e, this._scroll(this.offset + n));else {
        ...
        value: function value(t) {
          ...
          if (n.length) {
            if (n[0].complete) {
              var s = n.height();
              if (s > 0) this.$el.css("height", s + "px");else {
  ...
  var e = {
    ...
    i = function (i) {
      function n(e, i) {
        _classCallCheck(this, n);
        var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
        return s.el.M_FeatureDiscovery = s, s.options = t.extend({}, n.defaults, i), s.isOpen = !1, s.$origin = t("#" + s.$el.attr("data-target")), s._setup(), s._calculatePositioning(), s._setupEventHandlers(), s;
      }
      return _inherits(n, Component), _createClass(n, [{
        key: "destroy",
        value: function value() {
          this._removeEventHandlers(), this.el.FeatureDiscovery = void 0;
        }
      }, {
        key: "_setupEventHandlers",
        value: function value() {
        ...
        value: function value() {
          ...
          if (!e) for (var i = this.$origin.parents(), n = 0; n < i.length && !(e = "fixed" == t(i[n]).css("position")); n++);
          var s = this.$origin.outerWidth(),
            ...
            B = g / 2 - T / 2,
            I = {};
          I.top = v ? _ + "px" : "", I.right = p ? l - k - g + "px" : "", I.bottom = f ? h - _ - y + "px" : "", I.left = c ? k + "px" : "", I.position = b, t(this.wrapper).css(I), t(this.contentEl).css({
            width: C + "px",
            height: w + "px",
            top: E + "px",
            right: "0px",
    ...
    i = function (i) {
      ...
      return _inherits(n, Component), _createClass(n, [{
        ...
        value: function value(e) {
          ...
          return i ? this._keysSelected[e] = !0 : delete this._keysSelected[e], t(this._valueDict[e].optionEl).toggleClass("active"), t(this._valueDict[e].el).prop("selected", i), i;
        }
      }, {
...
/***/ "./resources/css/inc/material-icons.css":
/*!**********************************************!*\
  !*** ./resources/css/inc/material-icons.css ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/css/inc/materialize.min.css":
/*!***********************************************!*\
  !*** ./resources/css/inc/materialize.min.css ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"/js/materialize.min": 0,
/******/ 			"css/gold": 0,
/******/ 			"css/materialize.min": 0,
/******/ 			"css/material-icons": 0,
/******/ 			"css/babylon": 0,
/******/ 			"css/app": 0
/******/ 		};
/******/ 		
...
/******/ 	__webpack_require__.O(undefined, ["css/gold","css/materialize.min","css/material-icons","css/babylon","css/app"], () => (__webpack_require__("./resources/css/inc/materialize.min.js")))
/******/ 	__webpack_require__.O(undefined, ["css/gold","css/materialize.min","css/material-icons","css/babylon","css/app"], () => (__webpack_require__("./resources/css/app.css")))
/******/ 	__webpack_require__.O(undefined, ["css/gold","css/materialize.min","css/material-icons","css/babylon","css/app"], () => (__webpack_require__("./resources/css/babylon.css")))
/******/ 	__webpack_require__.O(undefined, ["css/gold","css/materialize.min","css/material-icons","css/babylon","css/app"], () => (__webpack_require__("./resources/css/inc/gold.css")))
/******/ 	__webpack_require__.O(undefined, ["css/gold","css/materialize.min","css/material-icons","css/babylon","css/app"], () => (__webpack_require__("./resources/css/inc/material-icons.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/gold","css/materialize.min","css/material-icons","css/babylon","css/app"], () => (__webpack_require__("./resources/css/inc/materialize.min.css")))
